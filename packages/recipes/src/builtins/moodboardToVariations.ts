...
export const moodboardToVariationsRecipe = manifest({
  ...
  requirements: [llm, generate], checkpoints: [checkpoint(graphRef, "compare", "Choose the most promising variation")], calls: 2, workItems: 4,
  scenario: { id: "moodboard-to-variations-fake", steps: [
    ...
    { kind: "success", requirementId: "image", latencyMs: 12, outputs: [{ graphRef, nodeRef: "image", channel: "image", fixtureId: "moodboard-variation-1", mediaType: "image/png" }] }
  ] }
});
