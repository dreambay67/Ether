...
/** Development-only renderer benchmark; never candidate performance evidence. */
export default defineConfig({
  testDir: "./tests/performance",
  testMatch: ["canvas.browser.performance.spec.ts"],
  outputDir: "../../test-results/performance-diagnostic",
  timeout: 60_000,
  workers: 1,
