...
export const graphTools: EtherToolDefinition[] = [
  ...
  },
  {
    ...
    inputSchema: EmptyInputSchema,
    outputSchema: mcpToolOutputSchemas["ether.graph.catalog"],
    annotations: readOnlyAnnotations,
    async run({ application }) {
  ...
  },
  {
    ...
    outputSchema: mcpToolOutputSchemas["ether.graph.inspect"],
    annotations: readOnlyAnnotations,
  ...
  },
  {
    ...
    inputSchema: z.object({ graphId: NonEmptyIdSchema }).strict(),
    outputSchema: mcpToolOutputSchemas["ether.graph.validate"],
    annotations: readOnlyAnnotations,
    async run({ application }, input) {
  ...
  },
  {
    ...
    outputSchema: mcpToolOutputSchemas["ether.graph.transaction.preview"],
    annotations: readOnlyAnnotations,
  ...
  },
  {
    ...
    outputSchema: mcpToolOutputSchemas["ether.graph.transaction.apply"],
  ...
  },
  {
    ...
    outputSchema: mcpToolOutputSchemas["ether.graph.transaction.reject"],
    annotations: readOnlyAnnotations,
