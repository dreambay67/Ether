...
export function ModuleNode({ id, data, selected }: NodeProps & { data: { title: string; description: string; accent: string; locked: boolean; collapsed: boolean; inputs: Array<{ id: string; channel: PayloadChannel }>; outputs: Array<{ id: string; channel: PayloadChannel }>; readOnly: boolean; onEnter(id: string): void; onToggle(id: string): void; onHandleActivate(id: string, handleId: string, handleType: "source" | "target"): void } }) {
