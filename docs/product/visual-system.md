...
Ether follows the supplied Ether and DreamBay visual identity references:

- `C:/Users/deny7/Downloads/Ether-Visual-Identity-Handbook.pdf`
- `C:/Users/deny7/Downloads/DreamBay-Visual-Identity-Handbook.pdf`

The repo-local brand assets are copied from:

- `C:/Users/deny7/Downloads/Ether_logo.png` to `packages/brand/src/assets/Ether_logo.png`
- `C:/Users/deny7/Downloads/DB_logo.png` to `packages/brand/src/assets/DB_logo.png`
...
- DreamBay gradient is an inherited brand highlight, not a generic full-screen wash.
