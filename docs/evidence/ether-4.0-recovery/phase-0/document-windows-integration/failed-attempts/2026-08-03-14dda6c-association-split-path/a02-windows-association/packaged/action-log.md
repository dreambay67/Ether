...
- Started: 2026-08-03T02:46:20.462Z
- Finished: 2026-08-03T02:46:38.538Z
...
| --- | --- | --- | --- | --- | ---: | --- |
| 1 | left-click | Create a test-owned association document | A visible blank-UI node is saved before Explorer invokes the association. | Left click at (91, 313). | 38 |  |
| 2 | keyboard-command | Save association document through native picker | The association target is a unique test-owned .ether document. | Pressed Control+s. | 63 |  |
