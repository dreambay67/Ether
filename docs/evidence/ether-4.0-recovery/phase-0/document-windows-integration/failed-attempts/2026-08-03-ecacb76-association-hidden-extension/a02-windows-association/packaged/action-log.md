...
- Mode: packaged
- Outcome: failed
- Git commit: ecacb76a11868b3334fece88904d9a5e82717125
- Profile: fresh-isolated; APPDATA, LOCALAPPDATA, and userData isolated
- Viewport: 1280×720; scale 1
- Started: 2026-08-03T02:51:53.962Z
- Finished: 2026-08-03T02:52:28.045Z
...
| --- | --- | --- | --- | --- | ---: | --- |
| 1 | left-click | Create a test-owned association document | A visible blank-UI node is saved before Explorer invokes the association. | Left click at (91, 313). | 62 |  |
| 2 | keyboard-command | Save association document through native picker | The association target is a unique test-owned .ether document. | Pressed Control+s. | 26 |  |
