...
- Started: 2026-08-03T04:17:56.483Z
- Finished: 2026-08-03T04:18:03.047Z
...
| 2 | observation | Association dry run | The exact HKCU .ether key and original ProgID state are snapshotted before any future optional mutation. | Dry-run plan uses unique Ether.Recovery.a985ec73206f4e619bb75acc0e56a4b5; this harness does not mutate the registry or invoke Explorer. | 0 |  |
| 3 | observation | Clean close through keyboard | A native Alt+F4 sent to the exact packaged Ether window closes the Saved document without an unsaved-changes prompt. | native-keyboard ownerPid=6576 shortcut=Alt+F4 | 0 |  |
